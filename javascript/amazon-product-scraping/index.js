...
async function main() {
    ...
    try {
        ...
        const products = await stagehand.extract("Extract the details of the FIRST 3 products in the search results. Get the product name, price, star rating, number of reviews, and the URL link to the product page.", ProductsSchema);
