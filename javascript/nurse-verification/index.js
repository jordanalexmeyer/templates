...
async function main() {
    ...
    try {
        ...
        for (const LicenseRecord of LicenseRecords) {
            ...
            const results = await stagehand.extract("Extract ALL the license verification results from the page, including name, license number and status", z.object({
                list_of_licenses: z.array(z.object({
                    name: z.string(),
