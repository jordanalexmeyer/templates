...
async function main() {
    ...
    try {
        ...
        try {
            const extractedInfo = await stagehand.extract("Extract the company name and CIK number from the page header or company information section. The CIK should be a numeric identifier.", CompanyInfoSchema);
        ...
        result.filings.forEach((filing, index) => {
            ...
            console.log(`  Description: ${filing.description.substring(0, 80)}${filing.description.length > 80 ? "..." : ""}`);
