...
async function applyToJob(jobInfo, semaphore, release) {
    ...
    try {
        ...
        console.log(`[${jobInfo.title}] Watch live: https://browserbase.com/sessions/${stagehand.browserbaseSessionId}`);
...
async function main() {
    ...
    const jobsData = await stagehand.extract("extract all job listings with their titles and URLs", z.array(JobInfoSchema));
