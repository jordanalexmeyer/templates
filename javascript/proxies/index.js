...
async function testSession(sessionFunction, sessionName) {
    console.log(`\n=== Testing ${sessionName} ===`);
    ...
    try {
        ...
        const geoInfo = await stagehand.extract("Extract all IP information and geolocation data from the JSON response", z.object({
