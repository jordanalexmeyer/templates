...
| business-lookup                  | [TS](typescript/business-lookup)                  | [PY](python/business-lookup)                  | -                   | Retrieve official business registry records through Browserbase Fetch API                                      |
...
| company-value-prop-generator     | [TS](typescript/company-value-prop-generator)     | [PY](python/company-value-prop-generator)     | -                   | Extract structured website value propositions through Browserbase Fetch API                                    |
...
| council-events                   | [TS](typescript/council-events)                   | [PY](python/council-events)                   | -                   | Fetch structured event information from the Philadelphia Council calendar                                      |
...
| sec-filing-research              | [TS](typescript/sec-filing-research)              | [PY](python/sec-filing-research)              | -                   | Retrieve official SEC company and recent filing metadata through Browserbase Fetch API                         |
...
| website-link-tester              | [TS](typescript/website-link-tester)              | [PY](python/website-link-tester)              | -                   | Fetch a homepage, collect its links, and report broken destinations without browser sessions                   |
