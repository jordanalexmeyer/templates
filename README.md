...
| extend-browserbase               | [TS](typescript/extend-browserbase)               | [PY](python/extend-browserbase)               | [GO](go/extend-browserbase) | Download receipts from an expense portal and extract structured receipt data using AI-powered document parsing |
